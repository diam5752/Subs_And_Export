...
function LoginProviders({ onAuthenticated }: { onAuthenticated: () => void }) {
  const { t } = useI18n();
  return (
    <>
      <GoogleSignInControl onAuthenticated={onAuthenticated} />
    ...
    <div className="auth-shell">
      ...
      <main className="auth-main animate-fade-in">
        ...
        <section className="auth-card" aria-labelledby="login-title">
          ...
          <LoginProviders onAuthenticated={() => router.push("/")} />

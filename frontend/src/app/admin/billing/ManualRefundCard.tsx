...
export function ManualRefundCard({
    ...
    const submitAccounting = handleSubmit(async (values) => {
        const adjustmentIssuedAt = parseAthensDateTime(
            values.adjustmentIssuedAt,
        );
        ...
        try {
            const record = await api.recordManualRefundAccounting(
                review.reversal_id,
                {
                    ...
                    adjustment_document: {
                        document_type: (
                            values.adjustmentDocumentType.trim()
                        ),
        ...
        >
                ...
                <div className="flex flex-wrap items-start justify-between gap-4">
                    ...
                    <div className="text-right">
                        ...
                        <p className="mt-1 text-xs text-red-900">
                            {formatDateTime(
                                review.stripe_refund_created_at,
                                locale,
                            )}
                            {' · '}
                            {ATHENS_TIME_ZONE}
            ...
            >
                            ...
                            <label className="grid gap-2 text-sm font-semibold">
                                ...
                                <input
                                    ...
                                    {...register('originalIssuedAt', {
                                        required: (
                                            t(
                                                'adminBillingInvalidIssuedAt',
                                            )
                                        ),
                                        validate: (value) => {
                                            const issuedAt = (
                                                parseAthensDateTime(value)
                                            );
                                            if (issuedAt === null) {
                                                return t(
                                                    'adminBillingInvalidIssuedAt',
                        ...
                        <label className="grid gap-2 text-sm font-semibold">
                            ...
                            <input
                                ...
                                {...register('adjustmentDocumentType', {
                                    required: (
                                        t(
                                            'adminBillingInvalidAdjustmentType',
                                        )
                                    ),
                                    pattern: {
                                        value: (
                        ...
                        <label className="grid gap-2 text-sm font-semibold">
                            ...
                            <input
                                ...
                                {...register('adjustmentSeries', {
                                    required: (
                                        t(
                                            'adminBillingInvalidAdjustmentSeries',
                                        )
                                    ),
                                    validate: (value) => (
                            ...
                            <input
                                ...
                                {...register('adjustmentMark', {
                                    ...
                                    validate: (value) => {
                                        ...
                                        return value !== originalMark
                                            || t(
                                                'adminBillingAdjustmentIdentityConflict',
                                            );
                                    },
                                })}
                            />
                                ...
                                {...register('adjustmentIssuedAt', {
                                    ...
                                    validate: (value) => {
                                        ...
                                        if (
                                            ...
                                            return t(
                                                'adminBillingAdjustmentBeforeRefund',
                                            );
                                        }
                                        return true;
                                    },
                ...
                <label className="flex items-start gap-3 rounded-2xl border border-red-300 bg-red-50 p-4 text-sm font-semibold leading-6 text-red-950">
                    ...
                    />
                    <span>
                        {t('adminBillingFinalRefundActionsConfirm')}
                    </span>
                </label>

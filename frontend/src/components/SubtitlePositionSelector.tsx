                                    ...
                                    <div className="relative">
                                        ...
                                        <div className="flex justify-between mt-2 px-1">
                                            {sizePresets.map((preset) => (
                                                ...
                                                className={`text-[10px] px-1.5 py-0.5 rounded transition-all focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:outline-none focus-visible:ring-offset-1 focus-visible:ring-offset-[var(--card-bg)] ${subtitleSize === preset.value
                                            ...
                                            <div className="flex justify-between mt-2 px-1">
                                                {positionPresets.map((preset) => (
                                                    <button
                                                        ...
                                                        className={`text-[10px] px-1.5 py-0.5 rounded transition-all focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:outline-none focus-visible:ring-offset-1 focus-visible:ring-offset-[var(--card-bg)] ${value === preset.value
                                                            ? 'text-[var(--accent)] font-medium'
                                                            : 'text-[var(--muted)] hover:text-[var(--foreground)]'
                                                            }`}
                                                    >
                                ...
                                <div className="flex flex-col gap-2" role="radiogroup" aria-labelledby={linesLabelId}>
                                    {lineOptions.map((opt) => (
                                        <button
                                            ...
                                            className={`p-3 rounded-xl border text-left transition-all flex items-center justify-between group focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--surface-elevated)] ${lines === opt.value
                                ...
                                <div className="flex flex-nowrap gap-4 justify-center w-full items-center relative" ref={gridRef}>
                                    ...
                                    {colors.slice(0, 3).map((c) => (
                                        <button
                                            ...
                                            className="group relative p-1 transition-transform active:scale-95 rounded-full focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--surface-elevated)]"
                                            title={c.label}
                                            role="radio"
                        ...
                        {onChangeKaraoke && karaokeSupported && (
                            <div className="flex-1 min-w-[200px]">
                                ...
                                <button
                                    ...
                                    className={`w-full p-4 rounded-xl border text-left transition-all duration-300 flex items-center justify-between group min-h-[88px] relative overflow-hidden focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--background)] ${karaokeEnabled
                        ...
                        {onChangeWatermark && (
                            <div className="flex-1 min-w-[200px]">
                                ...
                                <button
                                    ...
                                    className={`w-full h-[88px] rounded-xl border text-left transition-all duration-300 flex items-center justify-between px-6 group relative overflow-hidden focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--background)] ${watermarkEnabled

...
export const SubtitlePositionSelector =
  React.memo<SubtitlePositionSelectorProps>(
    ({
      lines,
      onChangeLines,
      subtitleColor,
            ...
            <div className="editor-style-controls-layout flex-1">
              ...
              <div className="editor-style-primary-row">
                ...
                >
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <InfoTooltip
                      ariaLabel={`${t("infoPrefix")} ${t("sizeLabel")}`}
                    >
                ...
                >
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <InfoTooltip
                      ariaLabel={`${t("infoPrefix")} ${t("maxLinesLabel")}`}
                    >
                      <div className="space-y-2">
                        <div className="font-semibold text-[11px]">
                          {t("maxLinesLabel")}
                  ...
                  >
                    {lineOptions.map((opt) => (
                      ...
                      >
                        <div>
                          <div
                            className={`font-medium text-sm transition-colors ${lines === opt.value ? "text-[var(--accent)]" : ""}`}
                          >
                            {opt.label}
                          </div>
              ...
              >
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <InfoTooltip
                    ariaLabel={`${t("infoPrefix")} ${t("colorLabel")}`}
                  >
                    <div className="space-y-2">
                      <div className="font-semibold text-[11px]">
                        {t("colorLabel")}
                      ...
                      <div className="flex items-center gap-2 rounded-lg border border-white/10 bg-black/20 p-2">
                        <span
                          aria-hidden="true"
                          className="h-3.5 w-3.5 rounded-full bg-[#FFFF00] border border-white/10"
                        />
                        <span
                          aria-hidden="true"
                          className="h-3.5 w-3.5 rounded-full bg-[#8B5CF6] border border-white/10"
                        />
                        <span
                          aria-hidden="true"
                          className="h-3.5 w-3.5 rounded-full bg-[#00FFFF] border border-white/10"
                        />
                      </div>
                    </div>
                  </InfoTooltip>
                ...
                >
                  ...
                  >
                    ...
                    {colors.slice(0, 3).map((c) => (
                      ...
                      >
                        <div
                          className={`editor-style-color-dot rounded-full border-2 shadow-sm transition-all duration-300 ease-out ${
                    ...
                    <div className="editor-style-color-more">
                      ...
                      >
                        <div
                          className={`editor-style-color-dot rounded-full border-2 shadow-md transition-all duration-300 ease-out flex items-center justify-center overflow-hidden bg-[var(--surface)] ${
                            showColorGrid ||
                            !colors
                              .slice(0, 3)
                              .some((c) => c.value === subtitleColor)

                        ...
                        <div className="p-5 pb-[calc(env(safe-area-inset-bottom)_+_1.25rem)] sm:p-6">
                            <div className="flex items-start justify-between gap-4">
                                <div>
                                    ...
                                    <h2
                                        className="mt-1 text-xl font-extrabold tracking-[-0.025em] text-[#111215]"
                                    >
                                        {t('feedbackTitle')}
                                    </h2>
                                </div>
                                    ...
                                    <div className="mt-4 grid grid-cols-2 gap-2">
                                        <button
                                            ...
                                            onClick={() => {
                                                ...
                                                setCanSubmit(false);
                                                setFormStartedAt(Math.floor(Date.now() / 1_000));
                                                window.setTimeout(() => setCanSubmit(true), MIN_FORM_AGE_MS);
                                            }}
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        <input
                                                            ...
                                                            {...register('category')}
                                                            onChange={() => setValue('category', category.value, {
                                                                shouldDirty: true,
                                                            })}
                                                        />
                                                        <span

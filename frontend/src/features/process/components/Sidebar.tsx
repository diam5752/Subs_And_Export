...
export function Sidebar() {
    ...
    // Memoize the sidebar content to prevent re-renders on currentTime updates (from Context).
    // This isolates the heavy DOM structure from high-frequency playback updates.
    return useMemo(() => {

...
export function Sidebar() {
    ...
    // Wrap the returned JSX in useMemo to prevent re-renders when currentTime updates but visual output doesn't change
    return useMemo(() => {
        ...
        isSavingTranscript,
        cues,
        activeCueIndex, // Derived from currentTime, but stable-ish
        editingCueIndex,
        editingCueDraft,
        handleUpdateDraft,
        beginEditingCue,

    ...
    return useMemo(() => (
        <div id="model-selection-step" className="card space-y-4">
            <div className="flex flex-wrap items-center justify-between gap-3 relative z-50">
                ...
                <button
                    type="button"
                    className="group/info relative z-20 pointer-events-auto shrink-0 rounded-full focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] cursor-help"
                    // @ts-expect-error - Key missing in type definition but present in fallback

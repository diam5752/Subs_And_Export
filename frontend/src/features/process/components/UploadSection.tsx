    ...
    return (
        ...
        >
            <span className="block text-[10px] font-semibold uppercase tracking-wide">
                {t('videoCreditPricingUpTo', { minutes: quote.maxDurationSeconds / 60 })}
            </span>
            ...
            <div className="mb-3 flex flex-wrap items-end justify-between gap-2">
                <div>
                    ...
                    <p className="mt-1 text-sm text-[var(--muted)]">
                        {durationSeconds
                            ? t('videoCreditPricingDuration', { duration: formatVideoDuration(durationSeconds) })
...
function resolveVideoCreditPricing(
    durationSeconds: number | null,
    provider: string | null | undefined,
    mode: string | null | undefined,
) {
    const selectedQuote = durationSeconds === null
    ...
    const selectedCost = durationSeconds === null
        ? selectedQuote.credits
        : processVideoCostForSelection(provider, mode, durationSeconds);
    return {
        selectedQuote,
        selectedCost,
        selectedDurationAvailable: durationSeconds === null
...
export function UploadSection() {
    ...
    return useMemo(() => {
        const pricingDuration = videoInfo?.durationSeconds
            ...
            ?? null;
        const { selectedQuote, selectedCost, selectedDurationAvailable } = resolveVideoCreditPricing(
            pricingDuration,
            transcribeProvider,
            transcribeMode,
        );

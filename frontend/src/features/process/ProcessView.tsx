...
// Optimized: Removed unused props (activeSidebarTab, hasVideos, isProcessing) to prevent
// unnecessary re-renders when these change in the parent context.
...
export function ProcessViewContent() {
    ...
    // Optimized: Wrap return value in useMemo to prevent unnecessary re-renders of ProcessViewLayout
    // when other context values (like progress or activeSidebarTab) update.
    return React.useMemo(() => (
        ...
        />
    ), [currentStep, STEPS, hasChosenModel, selectedJob, setOverrideStep]);
}

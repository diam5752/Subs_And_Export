...
readonly repo_root
audit_venv_candidate="$(mktemp -d "${TMPDIR:-/tmp}/gsp-audit-venv.XXXXXX")"
readonly audit_venv_candidate
audit_venv_dir="$(cd "${audit_venv_candidate}" && pwd -P)"
readonly audit_venv_dir

...
def reset_login_rate_limiter() -> None:
    ...
    """
    from backend.app.core.ratelimit import limiter_content, limiter_login, limiter_processing, limiter_register
...
def user_auth_headers(client):
    ...
    from backend.app.core.ratelimit import limiter_content, limiter_login, limiter_register
    limiter_login.reset()
    limiter_register.reset()
    limiter_content.reset()
